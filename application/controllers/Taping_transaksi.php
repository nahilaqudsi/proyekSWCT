...
class Taping_transaksi extends CI_Controller {
	...
	public function excel()
	{
		$this->load->model('Taping_transaksi_model');
		$data["export"] = $this->Taping_transaksi_model->getDataExport();
		$data["exportAssy"] = $this->Taping_transaksi_model->getDataAssy();
		$data['tb_assy'] = $this->Taping_transaksi_model->getTableAsi();
		$data['kop'] = $this->Taping_transaksi_model->getKop();
	...
	public function addNoAssy(){
		...
		$this->Taping_transaksi_model->addAssy();
		redirect('Taping_transaksi','refresh');
	} 

	// hapus assy
	public function hapusKodeAsi($assy){
		$this->Taping_transaksi_model->hapusKodeASSY($assy);
		redirect('Taping_transaksi','refresh');
	}

	public function delete($id){
		$this->Taping_transaksi_model->deleteExport($id);
		redirect('Taping_transaksi','refresh');
	}

	public function changeStatus($a,$b,$c){
		$this->Taping_transaksi_model->changeStatusAssy($a,$b,$c);
		redirect('Taping_transaksi','refresh');
		//$this->index();
	}

	public function deleteStatus($a,$b){
		$this->Taping_transaksi_model->gantiStatusLagi($a,$b);
		redirect('Taping_transaksi','refresh');
	...
	public function updateDataExport(){
		...
		$this->Taping_transaksi_model->updateDataExport($id,$detail_update,$critical,$os);
		// session
	...
	public function selectTaping(){
		...
		$final = $text;
		$grafik = $this->Taping_transaksi_model->getGrafikLast();
		...
		$this->Taping_transaksi_model->selectTaping($id,$t_critical,$t_os,$final,$t_std, $t_grafik);
	...
	public function updateKop(){
		...
		$this->Taping_transaksi_model->updateKop($id,$station,$customer,$carModel,$type,$tanggal,$noRev);
		redirect('Taping_transaksi','refresh');
	}
}
