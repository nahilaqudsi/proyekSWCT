        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <?php echo form_open_multipart('taping_spec/editlilitan/'.$this->uri->segment(3)); ?>
                                <?php echo validation_errors(); ?>
                                    <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                        <label>Jumlah Lilitan</label>
                                    </div>
                                    <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                                        <input type="text" class="form-control" id="jumlah_lilitan" name="jumlah_lilitan" required value="<?php echo $lilitan[0]->jumlah_lilitan ?>">
                                    </div>
