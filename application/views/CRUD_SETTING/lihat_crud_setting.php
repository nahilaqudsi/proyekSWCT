...
<div id="page-wrapper">
<div><br><center><h3><b>DETAIL ELEMEN KERJA SETTING</b></h3></center><hr></div>
    <div class="row">
                                     ...
                                     <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-sm-2"><center>
                                                <a href="<?php echo site_url('Crud_setting/editDetail/').$key->id_detail?>" type="button" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i>
                                                </a>
                                                <a href="<?php echo site_url('Crud_setting/deleteDetail/').$key->id_detail?>" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>
                                                </a></center>
                                            </td>
                                        </tr>
                                        <?php } ?>
