        ...
        <div class="panel-body">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <?php echo form_open_multipart('Crud_housing/editSyarat1/'.$this->uri->segment(3)); ?>
                      
                           <?php echo validation_errors(); ?>
                            <div class="col-lg-7">
                                <input type="text" class="form-control" id="syarat1" name="syarat1" value="<?php echo $daftar_syarat1[0]->syarat1 ?>">
                            </div>
