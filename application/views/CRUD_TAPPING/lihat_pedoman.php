...
<div id="page-wrapper">
<div><br><center><h3><b>PEDOMAN SWCT DAN STD TAPPING</b></h3></center><hr></div>
    <div class="row">
     ...
     <table class="table table-bordered" id="example2">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <?php echo $key->jml_lilitan ?></td>
                
                <td> <?php echo $key->tube1 ?> - <?php echo $key->tube2 ?> </td>
                <td> <?php echo $key->length1 ?> - <?php echo $key->length2 ?> </td>
                <td> <?php echo $key->jml_cct ?></td>
                <td> <?php echo $key->itensitas ?></td>
                <?php if ($key->vw=="1") {?>
                ...
                <td><center>
                    <a href="<?php echo site_url('Crud_tapping/editPedoman/').$key->id?>"><i class="glyphicon glyphicon-edit"></i> </a>
                    <a href="<?php echo site_url('Crud_tapping/deletePedoman/').$key->id?>" ><i class="glyphicon glyphicon-trash"></i> </a></center>
                </td>
            </tr>
        <?php } ?>
        </tbody> 
