...
<div id="page-wrapper">
<div><br><center><h3><b>DETAIL ELEMEN KERJA TAPPING</b></h3></center><hr></div>
    <div class="row">
        ...
        <table class="table table-bordered" id="example2">
            ...
            <tr>
                ...
                <td class="col-sm-2"><center>
                     <a href="<?php echo site_url('Crud_tapping/editDetail/').$key->id_detail?>" type="button" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i></a>
                     <a href="<?php echo site_url('Crud_tapping/deleteDetail/').$key->id_detail?>" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i></a></center>
                </td>
            </tr>
            <?php } ?>
            </tbody> 
