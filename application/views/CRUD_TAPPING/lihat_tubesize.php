...
<div id="page-wrapper">
<div><br><center><h3><b>DAFTAR TUBESIZE</b></h3></center><hr></div>
    <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                         ...
                         <table class="table table-bordered" id="example2">
                                    <thead>
                                     ...
                                     <tbody>
                                        <?php foreach ($daftar_tubesize as $key) { ?>
                                        <tr>
                                            <td><?php echo $key->tube1?>-<?php echo $key->tube2?></td>
                                            <td class="col-sm-2"><center>
                                                <a href="<?php echo site_url('Crud_tapping/editTubesize/').$key->id_tube?>" type="button" class="btn btn-success"><i class="glyphicon glyphicon-edit"></i>
                                                </a>
                                                <a href="<?php echo site_url('Crud_tapping/deleteTubesize/').$key->id_tube?>" type="button" class="btn btn-danger"><i class="glyphicon glyphicon-trash"></i>
                                                </a></center>
                                            </td>
                                        </tr>
                                        <?php } ?>
