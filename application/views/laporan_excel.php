...
header("Content-Disposition: attachment; filename=housingSWCT.xls");
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="4"><B> <font size="5"> HOUSING <?php if (!empty($kop)) { echo $kop->station; } ?></font></B></td>
			<td > NO. REV </td>
...
<table >
	<thead>
		...
		<tr>
			...
			<td style="border: thin solid;"></td>
			<?php if ($key->value_work=="1") {?> <td align="center" style="border: thin solid;"><?php echo $key->std ?></td> <?php } else {?>
            <td style="border: thin solid;"></td> <?php } ?>

            <?php if ($key->non_value_work=="1") {?> <td align="center" style="border: thin solid;"><?php echo $key->std ?></td><?php } else {?>
            <td style="border: thin solid;"></td> <?php }?>
